...
* [miyako/4D/.github/actions/tool4d-get-version@v1](https://github.com/miyako/4D/blob/v1/.github/actions/tool4d-get-version/action.yml) - tool parse `package.json`
* [actions/upload-release-asset](https://github.com/actions/upload-release-asset) - to upload .dmg
